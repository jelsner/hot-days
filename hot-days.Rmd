...
```
The overall max temperature averages are nearly the same. 

https://journals.ametsoc.org/doi/full/10.1175/MWR3284.1
P(TMAX2 >= 100 | TMAX) = P(TMAX | TMAX2 >= 100) * P(TMAX)
...
model1 <- glm(I(TMAX2 >= 98) ~ TMAX, 
              data = dfModel,
              family = "binomial")

predict(model1, 
        newdata = data.frame(TMAX = 100:101), 
        type = "response")
```
