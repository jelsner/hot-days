...
Improvements: Add Leon County border. Spell out TLH.
...
The airport record begins March 1, 1940. Since we are only interested in temperatures that occur during late spring and summer the missing months of Jan and Feb in 1940 do not influence the subsequent analysis.
...
How many? Monthly counts. Median date.
```{r}
TLH.df %>%
...
#  geom_text(aes(label = value), vjust = -.5, size = 2.5) +
  ...
  ylab("") + xlab("") +
  ggtitle(label = "Number of Extremely Hot Days",
          subtitle = "Tallahassee, Florida, USA (1940-2018)") +
  theme_minimal() +
  theme(panel.grid.minor = element_blank(),
